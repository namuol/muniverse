...
(function() {
  ...
  MenuItem = (function() {
    ...
    MenuItem.prototype.a = function() {
      return sounds.select.play();
    };

    MenuItem.prototype.b = function() {
      return sounds.cancel.play();
    };
  ...
  Hud = (function() {
    ...
    Hud.prototype.blit = function() {
      ...
      c.fillRect(HUD_X + HUD_SHIELD_X + 2, HUD_Y + HUD_SHIELD_Y + 9, HUD_BAR_W, HUD_BAR_H);
      h_diff = 0;
      if (player.shields > 0) {
      ...
      this.h += h_diff;
      return c.fillRect(HUD_X + HUD_SHIELD_X + 2, HUD_Y + HUD_SHIELD_Y + 9, HUD_BAR_W, this.h);
    };
  ...
  main = function() {
    gbox.setGroups(['background', 'game', 'starmap', 'planetmap', 'stationscreen', 'planet', 'stations', 'resources', 'particles', 'player', 'friend_shots', 'baddies', 'drones', 'foe_shots', 'hud', 'radar', 'message', 'dialog']);
    loadColors();
